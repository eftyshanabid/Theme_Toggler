    ...
    return (
        <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode} border-bottom border-2 border-${props.mode==='light'?'success':'warning'}`}>
            <div className="container-fluid">
                <a className="navbar-brand" style={{color: props.mode==='dark'?'red':'black'}} href='/'>{props.title}</a>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <a className="nav-link disabled" href='/' tabIndex="-1" aria-disabled="true">Beta v0.99</a>
                        </li>
                    </ul>
